            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ URL::route('admins.companies.index') }}">Buscar</a></li>
                        <li class="divider"></li>
                        <li><a href="/admins/companies/create">Agregar Empresa</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Proveedores <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ URL::route('admins.providers.index') }}">Buscar Proovedores</a></li>
                        <li class="divider"></li>
                        <li><a href="/admins/providers/create">Agregar Proveedor</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/admins/products">Buscar Productos</a></li>
                        <li class="divider"></li>
                        <li><a href="/admins/products/create">Agregar Producto</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ URL::route('admins.users.index') }}">Buscar</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ URL::route('admins.users.create') }}">Agregar Usuarios</a></li>
                    </ul>
                </li>
            </ul>
