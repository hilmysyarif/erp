...
<div class="centeredTitle">
    <h1>Productos de {{$provider->fancy_name}}</h1>
</div>
<hr>
<div class="col-md-4 col-md-offset-8 col-xs-8 col-xs-offset-4 col-lg-4 col-lg-offset-8">
    {{ Form::open(['url'=>'admins/providers/'.$provider_id.'/products/create','method'=>'get'])  }}
...
<div class ="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-xs-12 ">
    <table id="providers" class="row-border hover stripe" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <td>
              <a class="btn btn-default glyphicon glyphicon-trash" href="{{ URL::to('admins/providers/'.$provider_id.'/products/'.$product->id) }}"></a>
            </td>        
        </tr>
        @endforeach
